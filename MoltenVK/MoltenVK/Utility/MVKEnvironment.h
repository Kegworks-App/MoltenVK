...
#   define MVK_CONFIG_FULL_IMAGE_VIEW_SWIZZLE    1 // XXX Required by DXVK for AMD500/Intel GPUs
#endif
...
#   define MVK_CONFIG_RESUME_LOST_DEVICE    1 // XXX Required by WINE (doesn't handle VK_ERROR_DEVICE_LOST correctly)
#endif
