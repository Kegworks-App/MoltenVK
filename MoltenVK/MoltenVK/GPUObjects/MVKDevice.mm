...
void MVKPhysicalDevice::initFeatures() {
    ...
    _features.geometryShader = true;  // XXX Required by DXVK/WineD3D for D3D_FEATURE_LEVEL_*_*
    ...
    _features.shaderCullDistance = true;  // XXX Required by DXVK/WineD3D for D3D_FEATURE_LEVEL_9_1
